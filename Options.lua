...
local OmniBar = LibStub("AceAddon-3.0"):GetAddon("DjuxBar")
			...
			bars = {
				...
				args = {
					...
					import = {
						type = "execute",
						name = L["Import"],
						desc = L["Import an OmniBar/DjuxBar profile"],
						order = 3,
						func = "ShowImport",
						handler = OmniBar,
						width = 0.7,
...
export:SetStatusText(L["Copy this code to share this OmniBar/DjuxBar profile."])
export:Hide()
